...
public struct AnsiToken
{
    ...
    public AnsiToken(char newText)
    {
        Text = newText;
    }

    public AnsiToken(char nText,  (byte, byte, byte)? nForeGroundColor)
    {
        Text = nText;
        ForegroundColor = nForeGroundColor;
    }

    public AnsiToken(char nText, (byte, byte, byte)? nForeGroundColor, (byte, byte, byte)? nBackGroundColor)
    {
        Text = nText;
        ForegroundColor = nForeGroundColor;
